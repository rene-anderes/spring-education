-------------------------------------------------------------------------------
-- Create Script für die Cookbook-Database Version 2.0
-------------------------------------------------------------------------------
--------------------------------- Table Recipe --------------------------------
CREATE TABLE RECIPE (
...
CREATE UNIQUE INDEX SQL_INGREDIENT_IDX_01 ON INGREDIENT (UUID ASC);

CREATE INDEX SQL_INGREDIENT_IDX_02 ON INGREDIENT (RECIPE_ID ASC);

ALTER TABLE INGREDIENT ADD CONSTRAINT SQL_INGREDIENT_PK PRIMARY KEY (UUID);

ALTER TABLE INGREDIENT ADD CONSTRAINT INGREDIENTRECIPEID FOREIGN KEY (RECIPE_ID) REFERENCES RECIPE (UUID);
